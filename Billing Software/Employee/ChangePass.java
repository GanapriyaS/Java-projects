...
public class ChangePass extends javax.swing.JFrame {
    ...
    public ChangePass(Modal.empDetails ed) {
        initComponents();
        this.ed=ed;
        mail=ed.getEmail();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try(Connection con=dbConnection.getConnect();
            PreparedStatement ps=con.prepareStatement("select * from register where email='"+mail+"' and password='"+old+"'");
            ...
            if(rs.next())
            {
                if(new1.equals(new2))
                {
                    try(Connection con1=dbConnection.getConnect();
                        PreparedStatement ps1=con1.prepareStatement("update register set password='"+new1+"' where email='"+mail+"'");
                    )
                    {
